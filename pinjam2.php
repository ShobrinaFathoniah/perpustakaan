...
<html>
  <head>
    <title>Data Peminjaman Buku - Iread</title>
    <meta charset="utf-8">
      ...
      <header id="header" class="hoc clear"> 
        ...
        <nav id="mainav" class="fl_right">
          <ul class="clear">
            ...
            <li class = "active"><a href="pinjam2.php">Data Peminjaman</a></li>
        ...
        <br>
            ...
            <tr>
              ...
              <?php
                ...
                $sql = " select id_pinjam, id_buku, username, nama, judul, tgl_pinjam, jumlah, pengembalian from pinjam where username = '$nama' order by tgl_pinjam desc ";
                $result = $db-> query($sql);

                if($result-> num_rows > 0){
                  while($row = $result-> fetch_assoc()){
                    echo "<tr> <td>". $row["id_pinjam"]."</td><td>". $row["id_buku"]. "</td><td>". $row["nama"]."</td><td>". $row["judul"]."</td><td>". $row["tgl_pinjam"]."</td><td>". $row["jumlah"]. "</td><td>". $row["pengembalian"]. "</td></tr>" ;
                  }
