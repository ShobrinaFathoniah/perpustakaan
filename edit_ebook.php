...
<html>
    <head>
        <title>  Edit Data eBook (Administrator) - Iread </title>
    ...
    <body style="background-image:url('images/demo/backgrounds/bg.jpg'); background-repeat: no-repeat; background-size: cover;">
        <div id = "pinjam">
        <form action="ebook2.php" method="POST" >
            <br>
            <h2 style = "font-size: 50px;">Edit Data e-Book</h2>
            <table align = "center">
            <?php
                session_start();
                //connect to database
                ...
                $query = "select * from ebook where no= '$id'";
            ...
            ?>
                ...
                <tr>
                    ...
                    <td> <input type = "hidden" name = "edit_id" value = "<?php echo $row["no"]; ?>"> </td>
                </tr>
                <tr>
                    <td>
                        Judul
                ...
                <tr>
                    ...
                    <td></td>
                    <td> <input type = "text" name = "elink" value = "<?php echo $row["link"]; ?>"> </td>
                </tr>
                <tr> 
                    <td><br></td> 
                </tr>
