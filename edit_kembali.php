<html>
    <head>
        <title>  Edit Data Pengembalian Buku Perpustakaan (Administrator) - Iread </title>
    ...
    <body style="background-image:url('images/demo/backgrounds/bg.jpg'); background-repeat: no-repeat; background-size: cover;">
        <div id = "kembali">
        <form action="kembali2.php" method="POST" >
            <br>
            <h2 style = "font-size: 50px;">Edit Data Pengembalian Buku</h2>
            <table align = "center">
            <?php
                session_start();
                //connect to database
            ...
            ?>
                ...
                <tr>
                    <td>
                        Tanggal Mengembalikan Buku Pinjaman
                    </td>
                    <td></td>
                    <td> <input type = "date" name = "etgl_kembali" value = "<?php echo $row["tgl_kembali"]; ?>"> </td>
                </tr>
                <tr>
                    <td>
                        Jumlah Buku
