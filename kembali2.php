...
mysqli_select_db($db, 'perpus_aku');
  ...
  if(isset($_POST['delete_btn'])){
    ...
    if(isset($_POST['update_btn'])){
        ...
        $tgl_kembali = $_POST['etgl_kembali'];
        $jmlh = $_POST['ejmlh'];

      $query = "UPDATE pinjam SET id_pinjam = '$id_pinjam', username='$username', 
      id_buku = '$id_buku', judul = '$judul', tgl_pinjam = '$tgl_pinjam', tgl_kembali = '$tgl_kembali', 
      jumlah = '$jmlh' WHERE id_pinjam = '$id'";
...
<html>
  <head>
    <title>Data Pengembalian Buku (Administratir) - Iread</title>
    <meta charset="utf-8">
  ...
  <body id="top">
      ...
      <header id="header" class="hoc clear"> 
        ...
        <nav id="mainav" class="fl_right">
          ...
          <li><a href="home2.php">Home</a></li>
            ...
            <li class = "active"><a href="kembali2.php">Data Pengembalian</a></li>
    ...
    <div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/bg.jpg');">
        ...
        <br>
            ...
            <form action = "print_kembali.php" method="POST">
            ...
            <tr>
              ...
              //connect to database
                ...
                OR nama like '%".$pencarian."%' OR judul like '%".$pencarian."%' OR tgl_pinjam like '%".$pencarian."%' OR tgl_kembali like '%".$pencarian."%'
                OR jumlah like '%".$pencarian."%' ORDER BY tgl_kembali asc";
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                  echo "<tr><td>". $row["id_pinjam"]."</td><td>". $row["id_buku"]. "</td><td>". $row["id_anggota"]."</td><td>". $row["nama"]."</td><td>". $row["judul"]."</td><td>". $row["tgl_pinjam"]."</td><td>". $row["tgl_kembali"]. "</td><td>". $row["jumlah"]. "</td>" 
                    ?>
                  <td> <form action = "edit_kembali.php" method="POST">
